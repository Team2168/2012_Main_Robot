...
public class KeyPlusBridge extends CommandGroup
{
	public KeyPlusBridge(){
...
//		
		addSequential(new TankDriveToSpeed(0.6,-0.6),1);		//EDIT FOR 180 TURN!!!
		
		addSequential(new DriveToSpeed(0.6),1);			//EDIT FOR DISTANCE!!
